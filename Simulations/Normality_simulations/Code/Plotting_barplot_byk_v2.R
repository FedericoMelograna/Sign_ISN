...
setwd("C:/Users/fmelo/Desktop/Backup_Federico/Edge_mod_outlier/Simulations/Normality_simulations/Graphs/Graphs_grouped_by_k/Barplot/")
...
Cosine_dataset$K = as.factor(Cosine_dataset$K)
...
(g = plot_barplot_g( Dataset = LOO_avg_dataset, 0.4,0.7))
(g_nosd = plot_barplot_g_nosd( Dataset = LOO_avg_dataset, 0.4,0.7))


png("barplot_group_LOO_shr_pvalue.png", width = 300, height = 300, units='mm', res = 300)
g
dev.off()
png("barplot_group_LOO_shr_pvalue_nosd.png", width = 300, height = 300, units='mm', res = 300)
g_nosd
dev.off()
png("barplot_group_LOO_shr_pvalue_nosd_diffsize.png", width = 465, height = 225, units='mm', res = 300)
g_nosd
dev.off()
...
(g_nosd_pl_1out = plot_ggplot_nosd_( Dataset = ALL_avg_dataset, 0.3))
...
(g_nosd_pl = plot_ggplot_nosd_( Dataset = ALL_avg_dataset, 0.3))
(g_nosd_pl_ = plot_ggplot_nosd_( Dataset = ALL_avg_dataset, 0.3))
(g_nosd_pl_5out = plot_ggplot_nosd_( Dataset = ALL_avg_dataset, 0.3))
...
(g_nosd_pl = plot_ggplot_nosd_( Dataset = ALL_avg_dataset, 0.3))
(g_nosd_pl_= plot_ggplot_nosd_( Dataset = ALL_avg_dataset, 0.3))
(g_nosd_pl_10out = plot_ggplot_nosd_( Dataset = ALL_avg_dataset, 0.3))
