...
METHODS_dataset = c("auc.roc_cook_med","auc.roc_optics_k", "auc.roc_KNN_sqrt_N", "auc.roc_cook_max")
...
METHODS_avg_dataset$group[METHODS_avg_dataset$group == "auc.roc_optics_k"] = "OPTICS 5"
...
ALL_avg_dataset$group[ALL_avg_dataset$group == "auc.roc_optics_k"] = "OPTICS 5"
...
(g = plot_barplot_g( Dataset = ALL_avg_dataset,0,1,size = 30))
(g_nosd = plot_barplot_g_nosd( Dataset = ALL_avg_dataset,0,1,size = 30))
...
(g = plot_barplot_g( Dataset = ALL_avg_dataset,0.4,0.7,30))
(g_nosd = plot_barplot_g_nosd( Dataset = ALL_avg_dataset,0.4,0.7,30))
